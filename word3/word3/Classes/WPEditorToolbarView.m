...
//        toolbarScrollFrame = CGRectMake(0.0, 0.0, scrollviewWidth, WPEditorToolbarHeight);
        toolbarScrollFrame = CGRectMake(0.0, 0.0, self.frame.size.width, WPEditorToolbarHeight);
    }
...
//        [saveKeys addObject:@(ZSSRichTextEditorToolbarMore)];
        ...
        [saveKeys addObject:@(ZSSRichTextEditorToolbarH3)];
        [saveKeys addObject:@(ZSSRichTextEditorToolbarH4)];
        [saveKeys addObject:@(ZSSRichTextEditorToolbarH5)];
        [saveKeys addObject:@(ZSSRichTextEditorToolbarH6)];
...
//        toolbar.items = @[negativeSeparator];
//        
